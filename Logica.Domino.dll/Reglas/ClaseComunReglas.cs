...
public class ClaseComunReglas
{
    ...
    public ClaseComunReglas(int cantMinJugadores, int cantMaxJugadores, int cantFichas, int cantJugadores, int valorMaximoFichaDomino)
    {
    ...
    {
        Random a = new Random();
        return a.Next(0, cantJugadoresEnJuego + 1);
    }
}